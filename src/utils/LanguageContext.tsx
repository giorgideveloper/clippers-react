...
const translations: Record<LanguageCode, Record<string, string>> = {
  EN: {
    ...
    owner_admin: "Admin",
    shop_address:
      "72 Regent Imperial Blvd, New York • Open Daily 09:00 AM - 08:00 PM",
    ...
    services_subtitle:
      "CHOOSE FROM OUR EXQUISITE SUITE OF CLASSIC CUTS, MODERN FADES, AND SHAVES",
    ...
    barbers_subtitle:
      "SELECT THE TRUSTED CRAFTSMAN TO ALIGN YOUR PERSONAL AESTHETIC SIGNATURE",
    ...
    date_subtitle:
      "SELECT YOUR FAVORED CALENDAR DATE AND TIME SLOT FOR STANDING TREATMENT",
    ...
    checkout_subtitle:
      "RE-VERIFY YOUR CUSTOM SELECTION & ENTER CONTACT DETAILS FOR CONFIRMATION",
    cust_name: "Full Name",
    cust_phone: "Contact Phone",
    cust_email: "Email Address",
    cust_notes: "Special Directions or Requests",
    placeholder_notes:
      "e.g. Sharp taper fade, hot tea preferred, classic scissor cut blend...",
    ...
    success_desc:
      "Your signature grooming chair has been reserved. A confirmation ticket has been synchronized with our digital lounge registrar.",
    ...
    "service_sov-cut_desc":
      "Signature tailor-made haircut, double hot lather shampoo wash, blow-dry finish, and sharp straight-razor neck clean.",
    "service_buzz-fade_name": "Skin Fade & Edge",
    "service_buzz-fade_desc":
      "Ultra-precise skin-fade transition with personalized tapering and razor-sharp perimeter lining.",
    "service_beard-sculpt_name": "Beard Sculpt & Steam",
    "service_beard-sculpt_desc":
      "Detailed beard architectural sculpting, dynamic hot towel steam, premium sandalwood oil massage, and razor cheek lining.",
    "service_royal-shave_name": "Imperial Royal Shave",
    "service_royal-shave_desc":
      "Double pass straight-razor shave, pre-shave essential oil, rich lather applied with warm badger brush, and custom face massage.",
    "service_gent-combo_name": "The Gentlemen's Choice",
    "service_gent-combo_desc":
      "Our core combination: The Sovereign Cut meticulously paired with the Beard Sculpt & Steam. The gold standard package.",
    "service_royal-combo_name": "The Royal Treatment",
    "service_royal-combo_desc":
      "The Ultimate Sovereign indulgence: The Sovereign Cut alongside the Imperial Royal Shave, topped with a relaxing scalp care ritual.",

    // Dynamic Barbers Strings
    "barber_any-barber_name": "Any Available Stylist",
    "barber_any-barber_specialty":
      "Instant placement with first available master craftsman",
    ...
    "barber_marcus-sterling_specialty":
      "Precision Beard Architect & Razor Master",
    ...
    admin_new_craftsman_desc:
      "Stylist has been enrolled. High tier booking slots initialized.",

    // Admin Appointments & quick actions
    admin_live_schedule: "Live Agendas",
    admin_live_schedule_desc:
  ...
  KA: {
    ...
    owner_admin: "ადმინი",
    shop_address:
      "რეჯენტ იმპერიალ ბულვარი 72, ნიუ იორკი • ღიაა ყოველდღე 09:00 - 20:00",
    ...
    services_subtitle:
      "შეარჩიეთ ჩვენი დახვეწილი კლასიკური თმის შეჭრის, მოდური ფეიდებისა და პარსვის სერვისებიდან",
    ...
    barbers_subtitle:
      "აირჩიეთ გამოცდილი პროფესიონალი თქვენი პერსონალური სტილის დასახვეწად",
    ...
    date_subtitle:
      "შეარჩიეთ თქვენთვის სასურველი კალენდარული დღე და საათი ვიზიტისთვის",
    ...
    checkout_subtitle:
      "გადაამოწმეთ თქვენი არჩევანი და შეიყვანეთ საკონტაქტო მონაცემები დასადასტურებლად",
    cust_name: "სრული სახელი",
    cust_phone: "ტელეფონის ნომერი",
    cust_email: "ელ-ფოსტა",
    cust_notes: "სპეციალური მოთხოვნები",
    placeholder_notes:
      "მაგ. კლასიკური შეჭრა მაკრატლით, ცხელი ჩაი, ზუსტი კონტურები წვერზე...",
    ...
    success_desc:
      "თქვენი დახვეწილი სტილის სკამი რეზერვირებულია. დასტური სინქრონიზებულია ჩვენს ციფრულ სისტემასთან.",
    ...
    "service_sov-cut_desc":
      "კლასიკური ინდივიდუალური თმის შეჭრა, ორმაგი დაბანა ცხელი ქაფით და შამპუნით, დაფენვა და კისრის გასუფთავება საშიში სამართებლით.",
    "service_buzz-fade_name": "სკინ ფეიდი და კონტური",
    "service_buzz-fade_desc":
      "ულტრა-ზუსტი კონტურები და გადასვლები თმის შეჭრისას პერსონალური სტილის გათვალისწინებით.",
    "service_beard-sculpt_name": "წვერის მოდელირება და ორთქლი",
    "service_beard-sculpt_desc":
      "წვერის არქიტექტურული მოდელირება, ცხელი პირსახოცის ორთქლი, მასაჟი სანდალოზის ზეთით და ყელის გასუფთავება.",
    "service_royal-shave_name": "იმპერიული სამეფო პარსვა",
    "service_royal-shave_desc":
      "ორმაგი პარსვა საშიში სამართებლით, სპეციალური ზეთები, მდიდარი ქაფი და დამამშვიდებელი სახის მასაჟი.",
    "service_gent-combo_name": "ჯენტლმენის არჩევანი",
    "service_gent-combo_desc":
      "ოქროს სტანდარტის კომბინირებული პაკეტი: სოვერენის თმის შეჭრა და წვერის მოდელირება ცხელი ორთქლით.",
    "service_royal-combo_name": "სამეფო მომსახურება",
    "service_royal-combo_desc":
      "ლუქს კლასის სრული პაკეტი: სოვერენის შეჭრა, იმპერიული პარსვა და თავის კანის დამამშვიდებელი მოვლის რიტუალი.",

    // Dynamic Barbers Strings
    "barber_any-barber_name": "ნებისმიერი თავისუფალი ბარბერი",
    "barber_any-barber_specialty":
      "მყისიერი ჯავშანი პირველივე თავისუფალ ხელოსანთან",
    ...
    "barber_marcus-sterling_specialty":
      "წვერის არქიტექტორი და სამართებლის ოსტატი",
    "barber_elena-rostova_name": "ელენა როსტოვა",
    "barber_elena-rostova_specialty":
      "თანამედროვე ტექსტურები, ფენები და თმის ფერი",
    ...
    admin_welcome_subtitle:
      "მართეთ სამუშაო ცვლები, აკონტროლეთ ბარბერები და იხილეთ გამოხმაურებები",
    ...
    admin_form_crest_info:
      "ქმნის სამეფო მონოგრამას თქვენი სახელიდან გამომდინარე.",
    admin_form_success: "რეგისტრაცია წარმატებულია",
    admin_new_craftsman_added: "სტილისტი ამატებულია",
    admin_new_craftsman_desc:
      "ახალი ბარბერი წარმატებით დარეგისტრირდა სისტემაში. საათები აქტიურია.",

    // Admin Appointments & quick actions
    admin_live_schedule: "მიმდინარე განრიგი",
    admin_live_schedule_desc:
      "მართეთ ჯავშნები • დააკლიკეთ ბარათს სტატუსის შესაცვლელად",
    ...
    admin_reschedule_tip:
      "გთხოვთ შეარჩიოთ ახალი თავისუფალი დრო მოცემული ვიზიტისთვის.",
    ...
    settings_wipe_desc:
      "აღნიშნული ფუნქცია სრულად წაშლის თქვენს ამჟამინდელ კლიენტებს, ჯავშნებსა და პერსონალს ლოკალური მეხსიერებიდან და დააბრუნებს პირვანდელ მდგომარეობას.",
  ...
  RU: {
    ...
    owner_admin: "Админ",
    shop_address:
      "72 Regent Imperial Blvd, Нью-Йорк • Открыто ежедневно 09:00 - 20:00",
    ...
    services_subtitle:
      "ВЫБЕРИТЕ ИЗ НАШЕГО ИЗЫСКАННОГО КАТАЛОГА КЛАССИЧЕСКИХ СТРИЖЕК, СОВРЕМЕННЫХ ФЕЙДОВ И БРИТЬЯ",
    ...
    barbers_subtitle:
      "ВЫБЕРИТЕ ПРОФЕССИОНАЛА ДЛЯ СОЗДАНИЯ ВАШЕГО ИНДИВИДУАЛЬНОГО ОБРАЗА",
    ...
    checkout_subtitle:
      "ПРОВЕРЬТЕ ВЫБРАННЫЕ НАСТРОЙКИ И ВВЕДИТЕ ДАННЫЕ ДЛЯ ПОДТВЕРЖДЕНИЯ",
    cust_name: "Имя и фамилия",
    cust_phone: "Номер телефона",
    cust_email: "Электронная почта",
    cust_notes: "Особые пожелания",
    placeholder_notes:
      "например, стрижка классическими ножницами, горячий чай, подчеркнуть бороду...",
    ...
    success_desc:
      "Ваше кресло зарезервировано. Подтверждение автоматически синхронизировано с нашей системой администратора.",
    ...
    "service_sov-cut_desc":
      "Индивидуальная фирменная стрижка, мытье головы с двойным распаривающим массажем и бритье шеи опасной бритвой.",
    "service_buzz-fade_name": "Скин-Фейд и окантовка",
    "service_buzz-fade_desc":
      "Ультраточный переход со сведением на нет, персонализированная градуировка и бритвенная окантовка шеи и висков.",
    "service_beard-sculpt_name": "Архитектура бороды и пар",
    "service_beard-sculpt_desc":
      "Детализированное скульптурирование бороды с распариванием горячим компрессом и массажем с фирменным маслом.",
    "service_royal-shave_name": "Императорское бритье",
    "service_royal-shave_desc":
      "Традиционное бритье опасной бритвой в два захода, распаривающий компресс, густая пена и массаж лица.",
    "service_gent-combo_name": "Выбор Джентльмена",
    "service_gent-combo_desc":
      "Золотой стандарт ухода: Стрижка Sovereign Cut в сочетании с архитектурой бороды и горячим паром.",
    "service_royal-combo_name": "Королевский уход",
    "service_royal-combo_desc":
      "Абсолютный люкс Sovereign: Стрижка Sovereign Cut и Императорское бритье с расслабляющим уходом за кожей головы.",

    // Dynamic Barbers Strings
    "barber_any-barber_name": "Любой свободный мастер",
    "barber_any-barber_specialty":
      "Мгновенная запись к первому освободившемуся мастеру",
    ...
    "barber_marcus-sterling_specialty":
      "Архитектор бороды и мастер бритья опасной бритвой",
    "barber_elena-rostova_name": "Елена Ростова",
    "barber_elena-rostova_specialty":
      "Современные текстурные стрижки и колористика",
    "barber_julian-croft_name": "Джулиан Крофт",
    "barber_julian-croft_specialty":
      "Высокие скин-фейды и четкие геометрические линии",
    ...
    admin_welcome_subtitle:
      "Определяйте смены, координируйте мастеров и отслеживайте отзывы клиентов",
    ...
    admin_form_crest_info:
      "Создает благородную монограмму на основе инициалов мастера.",
    admin_form_success: "Регистрация успешна",
    admin_new_craftsman_added: "Мастер зарегистрирован",
    admin_new_craftsman_desc:
      "Новый барбер добавлен в систему. Рабочие часы активированы.",

    // Admin Appointments & quick actions
    admin_live_schedule: "Текущий день",
    admin_live_schedule_desc:
      "Управляйте визитами • Нажмите на карточку для открытия меню быстрых действий",
    ...
    admin_open_walk:
      "Интервал открыт для записи онлайн или клиентов без предварительной записи.",
    ...
    admin_reschedule_tip:
      "Пожалуйста, назначьте новое свободное время для выбранного визита.",
    ...
    settings_wipe_desc:
      "Данная операция полностью удалит текущие записи, клиентов и персонал из локального кэша и вернет демонстрационную базу к исходным демонстрационным значениям.",
...
export function LanguageProvider({ children }: { children: React.ReactNode }) {
  const [language, setLanguageState] = useState<LanguageCode>(() => {
    ...
    return saved && (saved === "KA" || saved === "EN" || saved === "RU")
      ? saved
      : "EN";
  });
